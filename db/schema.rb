...
ActiveRecord::Schema.define(version: 2021_10_17_171859) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "souscategory_id", null: false
    t.text "image_data"
    t.index ["souscategory_id"], name: "index_posts_on_souscategory_id"
  end
  ...
  add_foreign_key "posts", "souscategories"
